...
public class Client
{
    ...
    public Response get(String uri) throws Exception {
        return this.request(Request.METHOD_GET +" /"+ uri, null, null, null);
    }
    ...
    public Response post(String uri) throws Exception {
        return this.request(Request.METHOD_POST +" /"+ uri, null, null, null);
    }
    public Response post(String uri, Object uriParams) throws Exception {
        return this.request(Request.METHOD_POST +" /"+ uri, uriParams, null, null);
    }
    ...
    public Response put(String uri) throws Exception {
        return this.request(Request.METHOD_PUT +" /"+ uri, null, null, null);
    }
    ...
    public Response delete(String uri) throws Exception {
        return this.request(Request.METHOD_DELETE +" /"+ uri, null, null, null);
    }
